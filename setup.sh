...
# Installs 75+ skills, 21 plugins, 6 MCP servers
#
# Usage: bash setup.sh
#
...
echo "║     75+ Skills | 21 Plugins | 6 MCP Servers      ║"
echo "╚═══════════════════════════════════════════════════╝"
echo ""
...
# ─────────────────────────────────────────────
echo "=== Step 1/4: Installing GSD (38 project management skills) ==="
npx get-shit-done-cc@latest 2>/dev/null || echo "  ! GSD install may need to be run inside Claude Code"
echo ""

# ─────────────────────────────────────────────
# Step 2: UI/UX Pro Max Skill
# ─────────────────────────────────────────────
echo "=== Step 2/4: Installing UI/UX Pro Max Skill ==="
...
# ─────────────────────────────────────────────
echo "=== Step 3/4: Configuring plugins (21 enabled) ==="
...
# Step 4: MCP Servers
# ─────────────────────────────────────────────
echo "=== Step 4/4: Adding MCP Servers (6) ==="
...
echo ""
echo "  NOTE: Context7 and Playwright come pre-installed via plugins."
echo "  Run /mcp inside Claude Code to authenticate OAuth servers."
echo ""
